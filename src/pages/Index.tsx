        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              {/* Main headline */}
              <h1 className="text-6xl md:text-8xl font-bold mb-8 text-foreground tracking-tight leading-[1.1]">
                Master Your
                <span className="block mt-3 bg-gradient-to-r from-chart-1 via-chart-2 to-chart-3 bg-clip-text text-transparent">
                  Trading Edge
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                <Button 
                  ...
                  className="bg-chart-1 hover:bg-chart-1/90 text-white text-lg px-10 py-7 h-auto font-semibold shadow-[0_0_40px_-10px_hsl(var(--chart-1))] hover:shadow-[0_0_60px_-10px_hsl(var(--chart-1))] transition-all group"
                >
                  Start Free Trial
                ...
                <Button 
                  ...
                  variant="outline" 
                  onClick={() => navigate("/auth")} 
                  className="text-lg px-10 py-7 h-auto font-semibold border-2 border-border hover:border-chart-1/50 hover:bg-chart-1/5 transition-all"
                >
                  Watch Demo
                </Button>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              {benefits.map((benefit, index) => (
                <div 
                  key={index} 
                  className="flex items-start gap-4 p-6 rounded-xl bg-card/40 border border-border/50 hover:border-chart-1/50 hover:bg-card/60 transition-all hover:shadow-lg backdrop-blur-sm group"
                >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {features.map((feature, index) => (
              <Card 
                key={index} 
                className="border-border/50 bg-card/30 backdrop-blur-sm hover:bg-card/50 hover:border-chart-1/30 transition-all hover:shadow-xl hover:-translate-y-1 group"
              >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                ...
                variant="outline" 
                onClick={() => navigate("/auth")} 
                className="text-lg px-10 py-7 h-auto font-semibold border-2 border-border hover:border-chart-1/50 hover:bg-chart-1/5"
              >
                Talk to Sales
              </Button>
            </div>
