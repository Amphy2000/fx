  ...
  public: {
    Tables: {
      ...
      partner_message_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "partner_message_reactions_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
            referencedRelation: "partner_messages"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "partner_message_reactions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      promo_code_clicks: {
        ...
        Relationships: [
          {
            foreignKeyName: "promo_code_clicks_affiliate_id_fkey"
            columns: ["affiliate_id"]
            isOneToOne: false
            referencedRelation: "affiliate_profiles"
            referencedColumns: ["id"]
