...
DROP POLICY IF EXISTS "Anyone can insert analytics events" ON public.bundle_analytics;
...
DROP POLICY IF EXISTS "Admins can view all analytics" ON public.bundle_analytics;
